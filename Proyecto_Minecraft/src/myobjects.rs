...
static ACACIADOWN: Lazy<Arc<Texture>> = Lazy::new(|| Arc::new(Texture::new("assets/acaciadown.png")));
...
pub fn loadobjects() -> Vec<Cube>{
    ...
    let water = Material::new_with_text(0.0, [1.0, 0.0, 0.5, 0.0], 0.0, WATER.clone());
